...
module.exports = class client extends Client {
    ...
    reloadCommand(commandName) {
        ...
        else if (this.commandAliases.has(commandName)) command = this.commands.get(this.commandAliases.get(commandName));
        ...
        const requiredCommand = require(`${this._commandsFolder}${commandName}`);
        this.addCommand(new requiredCommand(this), commandName);
    }
    ...
    async init() {
        ...
        this.logger.ready('Ready eventi çalıştırılıyor...');
    }
